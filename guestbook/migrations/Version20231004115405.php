 ...
 */
final class Version20231004115405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD updated_at TIMESTAMP(0) DEFAULT CURRENT_TIMESTAMP');
        $this->addSql('COMMENT ON COLUMN category.created_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN category.updated_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE comment ADD updated_at TIMESTAMP(0) DEFAULT CURRENT_TIMESTAMP');
        ...
        $this->addSql('ALTER TABLE conference ADD updated_at TIMESTAMP(0) DEFAULT CURRENT_TIMESTAMP');
        ...
        $this->addSql('ALTER TABLE product ADD updated_at TIMESTAMP(0) DEFAULT CURRENT_TIMESTAMP');
