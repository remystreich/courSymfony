 ...
 */
final class Version20231004121131 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE conference ALTER created_at SET DEFAULT CURRENT_TIMESTAMP');
        $this->addSql('ALTER TABLE conference ALTER created_at DROP NOT NULL');
        $this->addSql('ALTER TABLE conference ALTER updated_at SET DEFAULT CURRENT_TIMESTAMP');
        $this->addSql('ALTER TABLE conference ALTER updated_at DROP NOT NULL');
